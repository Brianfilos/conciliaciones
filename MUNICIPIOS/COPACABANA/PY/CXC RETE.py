# -*- coding: utf-8 -*-
"""
Created on Thu Jul 25 08:48:20 2024
...
datos_exportar = excel_data[[
    ...
    '20. Intereses por mora ($ COP)', '22. Retención practicada en exceso, indebidas o por operaciones anuladas, rescindidas o resueltas o saldo a favor', 
...
actividades_data[['CIIU_Part1', 'CIIU_Part2']] = actividades_data['7. Código Actividad Económica CIIU'].str.split('-', expand=True)

# Crear un nuevo DataFrame con las columnas deseadas
detalles_data = actividades_data[['Consecutivo 1', 'CIIU_Part1', 'CIIU_Part2', '14.1 Actividad Industrial - Valor Retenido ($ COP)','15.1. Actividad Comercial - Valor Retenido ($ COP)','16.1 Actividad Servicios - Valor Retenido ($ COP)']]

# Asegurarse de que 'Consecutivo 1' esté en texto en ambos DataFrames para el cruce
datos_exportar['Consecutivo 1'] = datos_exportar['Consecutivo 1'].astype(str)
detalles_data['Consecutivo 1'] = detalles_data['Consecutivo 1'].astype(str)

# Hacer el cruce y agregar 'consecutivo_cxc' a detalles_data
detalles_data = detalles_data.merge(datos_exportar[['Consecutivo 1', 'consecutivo_cxc']], on='Consecutivo 1', how='left')
...
#detalles_data.drop(columns=['Consecutivo 1','CIIU_Part1','CIIU_Part2','CIIU_Part3','concepto'], inplace=True)
...
exce = datos_exportar[['consecutivo_cxc', '22. Retención practicada en exceso, indebidas o por operaciones anuladas, rescindidas o resueltas o saldo a favor']].copy()
exce = exce[exce['22. Retención practicada en exceso, indebidas o por operaciones anuladas, rescindidas o resueltas o saldo a favor'].notna()]
exce['concepto'] = '10153'
exce.rename(columns={'22. Retención practicada en exceso, indebidas o por operaciones anuladas, rescindidas o resueltas o saldo a favor': 'valor'}, inplace=True)
