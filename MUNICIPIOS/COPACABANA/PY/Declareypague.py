...
datos_exportar = excel_data[['Consecutivo 1', 'Tipo de documento', 'Número de documento', 'Primer nombre', 
                             ...
                             'Fecha Pago', 'Estado Pago', 'Consecutivo 2', 'Año Gravable', 
...
for valor in consecutivo_1: # Se itera sobre cada valor en la columna "Consecutivo 1".
    ...
    consecutivo_cxc = '903' + '0' * cantidad_ceros + valor_str #Se concatena '904' con la cantidad adecuada de ceros calculados 
...
def separar_codigo_descripcion(valor):
    if not isinstance(valor, str):  # Verificar si el valor no es una cadena
...
df_impuestos.loc[datos_impuesto['21. Impuesto de Avisos y Tableros ($ COP)'] != 0, 'concepto5'] = '10101'
...
df_impuestos.loc[datos_impuesto['23. Sobretasa Bomberil'] != 0, 'concepto6'] = '10111'
...
df_impuestos.loc[datos_impuesto['Digite valor sanciones a declarar'] != 0, 'concepto7'] = '10112'
df_impuestos.loc[datos_impuesto['Digite valor sanciones a declarar'] != 0, 'descripcion7'] = 'MULTAS Y SANCIONES DE INDUSTRIA Y COMERCIO'
...
df_impuestos.loc[datos_impuesto['37.INTERESES DE MORA'] != 0, 'concepto8'] = '10113'
df_impuestos.loc[datos_impuesto['37.INTERESES DE MORA'] != 0, 'descripcion8'] = 'INTERESES INDUSTRIA Y COMERCIO'
...
'23. Sobretasa Bomberil','Digite valor sanciones a declarar', '37.INTERESES DE MORA','39. Liquide el valor del pago voluntario']], on='Consecutivo 2', how='left')
...
'37.INTERESES DE MORA','21. Impuesto de Avisos y Tableros ($ COP)', '23. Sobretasa Bomberil','39. Liquide el valor del pago voluntario']]
...
# Calcular la autorretencion por actividad
df_porcentaje['voluntario'] = df_porcentaje['39. Liquide el valor del pago voluntario'] *df_porcentaje['Porcentaje']
...
df_porcentaje.loc[df_porcentaje['TIPO'] == 'INDUSTRIAL', 'concepto1'] = '10144'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'COMERCIAL', 'concepto1'] = '01100'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'SERVICIOS', 'concepto1'] = '10145'
...
df_porcentaje.loc[df_porcentaje['TIPO'] == 'INDUSTRIAL', 'concepto2'] = '10140'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'COMERCIAL', 'concepto2'] = '10139'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'SERVICIOS', 'concepto2'] = '10141'

# Añadir columna 'descripcion2' con valores predeterminados
df_porcentaje['descripcion2'] = ''

# Definir los valores de 'concepto1' según el valor en la columna 'TIPO'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'INDUSTRIAL', 'descripcion2'] = 'AUTORRETENCIONES ICA ANUAL INDUSTRIAL'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'COMERCIAL', 'descripcion2'] = 'AUTORRETENCIONES ICA ANUAL COMERCIAL'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'SERVICIOS', 'descripcion2'] = 'AUTORRETENCIONES ICA ANUAL SERVICIOS'
...
# Definir los valores de 'concepto2' según el valor en la columna 'TIPO'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'INDUSTRIAL', 'concepto3'] = '10137'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'COMERCIAL', 'concepto3'] = '10136ANT'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'SERVICIOS', 'concepto3'] = '10138'

# Añadir columna 'descripcion3' con valores predeterminados
df_porcentaje['descripcion3'] = ''

# Definir los valores de 'concepto1' según el valor en la columna 'TIPO'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'INDUSTRIAL', 'descripcion3'] = 'ANTICIPO AÑO ANTERIOR ICA INDUSTRIAL'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'COMERCIAL', 'descripcion3'] = 'ANTICIPO AÑO ANTERIOR ICA COMERCIAL'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'SERVICIOS', 'descripcion3'] = 'ANTICIPO AÑO ANTERIOR ICA SERVICIOS'

# Añadir columna 'concepto3' con valores predeterminados
df_porcentaje['concepto22'] = ''

# Definir los valores de 'concepto2' según el valor en la columna 'TIPO'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'INDUSTRIAL', 'concepto22'] = '10150'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'COMERCIAL', 'concepto22'] = '10151'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'SERVICIOS', 'concepto22'] = '10152'

# Añadir columna 'descripcion3' con valores predeterminados
df_porcentaje['descripcion22'] = ''

# Definir los valores de 'concepto1' según el valor en la columna 'TIPO'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'INDUSTRIAL', 'descripcion22'] = 'RETENCIONES DECLARACION ANUAL ICA INDUSTRIAL'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'COMERCIAL', 'descripcion22'] = 'RETENCIONES DECLARACION ANUAL ICA COMERCIAL'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'SERVICIOS', 'descripcion22'] = 'RETENCIONES DECLARACION ANUAL ICA SERVICIOS'

# Añadir columna 'concepto3' con valores predeterminados
df_porcentaje['concepto23'] = ''

# Definir los valores de 'concepto2' según el valor en la columna 'TIPO'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'INDUSTRIAL', 'concepto23'] = '10148'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'COMERCIAL', 'concepto23'] = '10147'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'SERVICIOS', 'concepto23'] = '10149'

# Añadir columna 'descripcion3' con valores predeterminados
df_porcentaje['descripcion23'] = ''

# Definir los valores de 'concepto1' según el valor en la columna 'TIPO'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'INDUSTRIAL', 'descripcion23'] = 'PAGO VOLUNTARIO ANUAL ICA INDUSTRIAL'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'COMERCIAL', 'descripcion23'] = 'PAGO VOLUNTARIO ANUAL ICA COMERCIAL'
df_porcentaje.loc[df_porcentaje['TIPO'] == 'SERVICIOS', 'descripcion23'] = 'PAGO VOLUNTARIO ANUAL ICA SERVICIOS'
...
# Seleccionar las columnas específicas para crear el DataFrame 'ICA'
columnas_seleccionadas = ['Consecutivo 2', 'concepto22', 'descripcion22', 'retencion']
RETE = df_porcentaje[columnas_seleccionadas]
# Mostrar las primeras filas del DataFrame 'AUTO'
print(RETE.head())

# Seleccionar las columnas específicas para crear el DataFrame 'ICA'
columnas_seleccionadas = ['Consecutivo 2', 'concepto23', 'descripcion23', 'voluntario']
VOL = df_porcentaje[columnas_seleccionadas]
# Mostrar las primeras filas del DataFrame 'AUTO'
print(VOL.head())
...
df_ica.rename(columns={'Consecutivo 2': 'declaracion', 'concepto1': 'concepto', 'descripcion1': 'descripcion', 'ICA': 'Valor'}, inplace=True)
df_auto.rename(columns={'Consecutivo 2': 'declaracion', 'concepto2': 'concepto', 'descripcion2': 'descripcion', 'autorrete': 'Valor'}, inplace=True)
df_anti.rename(columns={'Consecutivo 2': 'declaracion', 'concepto3': 'concepto', 'descripcion3': 'descripcion', 'anticipo': 'Valor'}, inplace=True)
df_rete.rename(columns={'Consecutivo 2': 'declaracion', 'concepto22': 'concepto', 'descripcion22': 'descripcion', 'retencion': 'Valor'}, inplace=True)
df_at.rename(columns={'Consecutivo 2': 'declaracion', 'concepto5': 'concepto', 'descripcion5': 'descripcion', '21. Impuesto de Avisos y Tableros ($ COP)': 'Valor'}, inplace=True)
df_st.rename(columns={'Consecutivo 2': 'declaracion', 'concepto6': 'concepto', 'descripcion6': 'descripcion', '23. Sobretasa Bomberil': 'Valor'}, inplace=True)
df_sanc.rename(columns={'Consecutivo 2': 'declaracion', 'concepto7': 'concepto', 'descripcion7': 'descripcion', 'Digite valor sanciones a declarar': 'Valor'}, inplace=True)
df_int.rename(columns={'Consecutivo 2': 'declaracion', 'concepto8': 'concepto', 'descripcion8': 'descripcion', '37.INTERESES DE MORA': 'Valor'}, inplace=True)
df_vol.rename(columns={'Consecutivo 2': 'declaracion', 'concepto23': 'concepto', 'descripcion23': 'descripcion', 'voluntario': 'Valor'}, inplace=True)
...
df_detalles = df_detalles[['declaracion','concepto', 'descripcion', 'Valor']]
...
df_detalles_fusionado['CENTRO DE COSTOS'] = 1501
df_detalles_fusionado['CANTIDAD'] = 1

# Duplicar la columna 'Valor' en el DataFrame df_detalles_fusionado
df_detalles_fusionado['Valor Unitario'] = df_detalles_fusionado['Valor']
df_detalles_fusionado['Valor Total'] = df_detalles_fusionado['Valor']

# Reordenar las columnas para tener los encabezados deseados
df_detalles_fusionado = df_detalles_fusionado[['declaracion','consecutivo_cxc', 'concepto', 'descripcion','CENTRO DE COSTOS', 'CANTIDAD', 'Valor Unitario', 'Valor Total']]
