...
urlpatterns = [
    ...
    path("envio/agregar/<int:proceso_id>/", views_envio.AgregarAlEnvioView.as_view(), name="envio_agregar"),
    path("envio/quitar/", views_envio.QuitarDelEnvioView.as_view(), name="envio_quitar"),
    path("configuracion/correo/", views_envio.ConfigCorreoView.as_view(), name="config_correo"),
    path("configuracion/correo/vista-previa/", views_envio.ConfigCorreoVistaView.as_view(), name="config_correo_vista"),
